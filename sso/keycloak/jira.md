...
###### Jira => System => SSO 2.0 => Saml single sign-on
```
...
https://jira.company.ru/plugins/servlet/samlconsumer
Audience URL (Entity ID)
https://jira.company.ru
```
Login mode:
...
| Option | Value |
| ------ | ------ |
| Client ID | https://jira.company.ru (value from Audience URL (Entity ID) confluence) |
| Enabled | ON |
...
| Valid Redirect URIs | https://jira.company.ru/* |
| Master SAML Processing URL | https://jira.company.ru/plugins/servlet/samlconsumer |

Leave the rest as they are.


### test
https://jira.company.ru/plugins/servlet/external-login
